...
Whether code is written manually or generated with AI, you and the AI must strictly follow the [CODE_STYLE_GUIDE.md](https://github.com/digreatbrian/tourist-destination-finder/blob/master/CODE_STYLE_GUIDE.md).
